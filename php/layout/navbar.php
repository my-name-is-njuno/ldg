    ...
    <header class="top-header">
        <nav class="navbar header-nav navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php"><img src="images/img/output-onlinejpgtools.png" width="140" alt="image"></a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link active" style="background:#f2184f;color:#fff;" data-toggle="modal" data-target="#my-modal">Book Appointment Now</a></li>
                    </ul>
                </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="my-modal-title">Book Appointment</h5>
